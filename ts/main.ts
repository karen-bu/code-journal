...
// an original drawing based on the passengers of a truck i pulled up to at a stoplight while driving down pacific avenue in my neighborhood of long beach, coming home from the rink. it was a delightful encounter :) when the light turned green, they drove away happily. i only wish i could have found out what their names were ...
...
$themeSelect?.addEventListener('click', (event: Event) => {
  const theme = event.target as HTMLAnchorElement;
...
function themeSwap(themeName: any): void {
